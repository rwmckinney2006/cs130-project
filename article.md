...
![A line chart comparing number of injuries to years of experience](Visualizations/number_of_injuries_by_years_of_experience.png)
...
![A line chart comparing number of injuries to amount of past injuries](Visualizations/past_injuries.png) 
...
![A bar chart comparing the weight(lbs) of injured players to position groups](Visualizations/injured_weight.png)

![A bar chart comparing the average weight(lbs) of NFL players to position groups](Visualizations/average_weight.png)
